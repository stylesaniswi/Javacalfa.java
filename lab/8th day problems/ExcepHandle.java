...
public class ExcepHandle {
    static void validate(String r, String n) {
        ...
        if (!m1.find()) {
            throw new NumberFormatException("Mobile Number cannot contain any character otherthan a digit");
        }
        String pattern2 = "^[1-9][0-9][A-Z a-z]{3}[0-9]{4}$";
    ...
    public static void main(String args[]) {
        String reg;
        String no;
        System.out.println("Enter the registeration number and the mobile number : ");
